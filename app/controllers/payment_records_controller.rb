class PaymentRecordsController < ApplicationController
  ...
  def create
    ...
    employee_time_logs = @payment_record.employee.time_logs.where(date_time_in: payment_record_params[:start_date].to_datetime..payment_record_params[:end_date].to_datetime, payment_record: nil)
