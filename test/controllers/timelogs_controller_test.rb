...
class TimelogsControllerTest < ActionController::TestCase
  ...
  test "should create timelog" do
    assert_difference('Timelog.count') do
      post :create, timelog: { date_in: @timelog.date_in, date_out: @timelog.date_out, employee_id: @timelog.employee_id }
    end
  ...
  test "should update timelog" do
    patch :update, id: @timelog, timelog: { date_in: @timelog.date_in, date_out: @timelog.date_out, employee_id: @timelog.employee_id }
    assert_redirected_to timelog_path(assigns(:timelog))
  end
